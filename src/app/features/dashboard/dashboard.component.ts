...
export class DashboardComponent {
    ...
    scrollingTextColor: string = '#000000'; // Noir
    ...
    activiteJour = [
        { label: 'Recettes perçues (Régies)', valeur: '2.4B', tendance: '+15%', icone: 'fas fa-arrow-down', couleur: 'text-info', montant: undefined, id: 'activite-recettes' },
    
        { label: 'Règlements effectués', valeur: '45', tendance: '+3', icone: 'fas fa-check-circle', couleur: 'text-success', montant: '1.2B FCFA', id: 'activite-reglements' },
        { label: 'Mandats émis', valeur: '128', tendance: '+12', icone: 'fas fa-file-invoice-dollar', couleur: 'text-primary', montant: '3.5B FCFA', id: 'activite-mandats' },
        { label: 'Nouveaux cautionnements', valeur: '8', tendance: '0', icone: 'fas fa-shield-alt', couleur: 'text-warning', montant: '850M FCFA', id: 'activite-cautionnements' }
    ];
    ...
    viewKpiDetail(kpiId: string) {
        this.router.navigate(['/dashboard/kpi', kpiId]);
    }

    viewActivityDetail(activityId: string) {
        this.router.navigate(['/dashboard/kpi', activityId]);
    }
}
