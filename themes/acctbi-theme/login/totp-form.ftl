                ...
                <div class="col-lg-6 d-none d-lg-flex bg-primary-dark auth-banner align-items-center justify-content-center flex-column text-white p-5 position-relative overflow-hidden">
                    ...
                    <div class="content-wrapper text-center z-1">
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3 mt-5">
                            <div class="feature-badge"><i class="fas fa-envelope-open-text fs-4 mb-2"></i><span>Email OTP</span></div>
                            <div class="feature-badge"><i class="fas fa-shield-alt fs-4 mb-2"></i><span>Sécurité</span></div>
                            <div class="feature-badge"><i class="fas fa-bolt fs-4 mb-2"></i><span>Rapide</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6 d-flex align-items-center justify-content-center bg-body">
                    <div class="auth-form-wrapper w-100 p-4 p-md-5">
                        <div class="text-center text-lg-start mb-5">
                            ...
                            <p class="text-secondary">Saisissez le code reçu par email pour valider votre connexion.</p>
                        </div>
                        ...
                        <form id="kc-email-totp-code-login-form" action="${url.loginAction}" method="post" class="needs-validation">
                            <div class="form-floating mb-4">
                                <input tabindex="1" type="text" class="form-control text-center fs-4 fw-bold" id="code" name="code" placeholder="123456" required autofocus autocomplete="one-time-code">
                                <label for="code">Code de vérification</label>
                            </div>

                            <button tabindex="2" type="submit" name="login" class="btn btn-primary w-100 py-3 fw-bold fs-6 mb-3">
                                Soumettre <i class="fas fa-check-circle ms-2"></i>
                            </button>

                            <button type="submit" name="resend" value="resend" class="btn btn-outline-secondary w-100 py-2 fw-medium border-0 shadow-none text-decoration-underline">
